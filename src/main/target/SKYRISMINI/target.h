...
#define TARGET_BOARD_IDENTIFIER "SKYF4"
#define USBD_PRODUCT_STRING  "SkyrisMINI"
...
#define USED_TIMERS             (TIM_N(1)|TIM_N(3)|TIM_N(5)|TIM_N(8)|TIM_N(9))
